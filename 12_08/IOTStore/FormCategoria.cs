...
namespace IOTStore
{
    public partial class FormCategoria : MaterialSkin.Controls.MaterialForm
    {
        ...
        {
            if (MessageBox.Show("Deseja fechar o Cadastro de Categorias?", "Sistema IOT Store", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                this.Close();
            }
        }
