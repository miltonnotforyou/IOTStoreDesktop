...
namespace IOTStore
{
    public partial class formCliente : MaterialSkin.Controls.MaterialForm
    {
        ...
        {
            if (MessageBox.Show("Deseja fechar o Cadastro de Clientes?", "Sistema IOT Store", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                this.Close();
            }
        ...
        private void btCadastrarCliente_Click(object sender, EventArgs e)
        {
            ...
            else // USUARIO PREENCHEU OS CAMPOS
            {
                ...
                cCliente.senha = BCrypt.Net.BCrypt.HashPassword(txtSenhaCliente.Text);
        ...
        private void btAtualizazCliente_Click(object sender, EventArgs e)
        {
            ...
            else // USUARIO PREENCHEU OS CAMPOS
            {
                ...
                // CRIPTOGRAFIA INTELIGENTE NA HORA DE ATUALIZAR:
                ...
                {
                    cCliente.senha = ""; // Se ficou vazio na tela, manda vazio pra classe ignorar no SQL
                }
