...
namespace IOTStore
{
    public partial class formRelVendaDetalhado : MaterialSkin.Controls.MaterialForm
    {
        ...
        private void formRelVendaDetalhado_Load(object sender, EventArgs e)
        {
            ...
            this.rptvVendaDetalhado.RefreshReport();
        }
        ...
        private void btGerarRelatorio_Click(object sender, EventArgs e)
        {
            ...
            switch (tipo_rel)
            {
                ...
                case 1:
                    ...
                    classRelVendaBindingSource.DataSource = cRelVenda.RelatorioVendaDetalhadoCliente(Convert.ToInt32(cbCliente.SelectedValue));
                    this.rptvVendaDetalhado.RefreshReport();
                    break;
                ...
                case 2:
                    ...
                    classRelVendaBindingSource.DataSource = cRelVenda.RelatorioVendaDetalhadoFuncionario(Convert.ToInt32(cbFuncionario.SelectedValue));
                    this.rptvVendaDetalhado.RefreshReport();
                    break;
                ...
                case 3:
                    ...
                    classRelVendaBindingSource.DataSource = cRelVenda.RelatorioVendaDetalhadoDataCliente(dtpDataInicial.Value,                dtpDataFinal.Value, codigoCliente);
                    rptvVendaDetalhado.RefreshReport();
                    break;
                ...
                case 4:
                    ...
                    classRelVendaBindingSource.DataSource = cRelVenda.RelatorioVendaDetalhadoDataFuncionario(dtpDataInicial.Value, dtpDataFinal.Value, codigoFuncionario);
                    rptvVendaDetalhado.RefreshReport();
                    break;
                ...
                //PERÍODO
                default:
                    classRelVendaBindingSource.DataSource = cRelVenda.RelatorioVendaDetalhadoData(Convert.ToDateTime(dtpDataInicial.Text), Convert.ToDateTime(dtpDataFinal.Text));
                    rptvVendaDetalhado.RefreshReport();
