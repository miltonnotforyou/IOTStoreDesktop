...
namespace IOTStore
{
    public partial class formPrincipal : MaterialSkin.Controls.MaterialForm
    {
        ...
        {
            if (Application.OpenForms.OfType<formVenda52>().Count() > 0)
            {
                MessageBox.Show("Formulário de Vendas já está aberto!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                formVenda52 obj_formRelProduto = new formVenda52();
                obj_formRelProduto.MdiParent = this;
                obj_formRelProduto.Show();
            }
        }
        ...
        private void vendasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Relatório de Vendas Detalhadas já está aberto!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                formRelVendaDetalhado obj_formRelVendaDetalhado = new formRelVendaDetalhado();
                obj_formRelVendaDetalhado.MdiParent = this;
                obj_formRelVendaDetalhado.Show();
            }
        }
        ...
        private void vendasToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Relatório de Vendas já está aberto!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                formRelVenda obj_formRelVenda = new formRelVenda();
                obj_formRelVenda.MdiParent = this;
                obj_formRelVenda.Show();
            }
        }

        private void dashboardToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (Application.OpenForms.OfType<formDashboard>().Count() > 0)
            {
                MessageBox.Show("Relatório de Vendas já está aberto!", "Atenção!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                formDashboard obj_formDashboard = new formDashboard();
                obj_formDashboard.MdiParent = this;
                obj_formDashboard.Show();
            }
        }
    }
}