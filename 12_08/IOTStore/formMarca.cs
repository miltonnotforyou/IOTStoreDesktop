...
namespace IOTStore
{
    public partial class formMarca : MaterialSkin.Controls.MaterialForm
    {
        ...
        {
            if (MessageBox.Show("Deseja fechar o Cadastro de Marcas?", "Sistema IOT Store", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                this.Close();
            }
        }
