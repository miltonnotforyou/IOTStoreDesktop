...
namespace IOTStore
{
    public partial class formFuncionario : MaterialSkin.Controls.MaterialForm
    {
        public formFuncionario()
        {
            ...
            // Inicializa e aplica o tema ao form
        ...
        private void formFuncionario_Load(object sender, EventArgs e)
        {
            ...
            if (tipo == "Atualização")
            {
                //Text = "Atualização de Funcionário";
        ...
        {
            if (MessageBox.Show("Deseja fechar o Cadastro de Funcionários?", "Sistema IOT Store", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                this.Close();
            }
        }
        ...
        private void btCadastrarFuncionario_Click(object sender, EventArgs e)
        {
            ...
            else // USUARIO PREENCHEU OS CAMPOS
            {
               ...
               if (maskedResidencial.Text == "(  )    -    ")
                ...
                cFuncionario.senha = BCrypt.Net.BCrypt.HashPassword(txtSenhaFuncionario.Text);
