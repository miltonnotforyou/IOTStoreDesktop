...
namespace IOTStore
{
    public partial class formCargo : MaterialSkin.Controls.MaterialForm
    {
        ...
        {
            if (MessageBox.Show("Deseja fechar o Cadastro de Cargos?", "Sistema IOT Store", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                this.Close();
            }
        }
